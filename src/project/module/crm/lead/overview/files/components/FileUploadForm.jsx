...
const FileUploadForm = ({ onSubmit, onCancel, isSubmitting }) => {
    ...
    const uploadProps = {
        onRemove: file => {
            ...
            // Clear filename if no files left
        ...
        beforeUpload: file => {
            ...
            // Set filename from the first uploaded file if not already set
    ...
    const handleSubmit = () => {
        ...
        // Create a simple FormData object with a clear structure
        ...
        fileList.forEach(file => {
            formData.append('leadFiles', file.originFileObj || file);
        });

        // Simple logging
        console.log("Submitting form with custom filename:", fileName);
    ...
    // Show warning if multiple files are selected
